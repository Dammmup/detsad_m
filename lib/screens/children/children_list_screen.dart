...
class _ChildrenListScreenState extends State<ChildrenListScreen> {
                                        ...
                                        if (child.birthday != null) ...[
                                          Row(
                                            children: [
                                              ...
                                              Text('День рождения: ${_formatBirthday(child.birthday!)}',
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                onTap: () async {
                                                  ...
                                                  await Clipboard.setData(ClipboardData(text: child.parentPhone!));
                                                  // Показываем сообщение об успешном копировании
                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                    SnackBar(
                                                      content: Text('Номер телефона скопирован: ${child.parentPhone}'),
                                                      duration: Duration(seconds: 2),
                                                    ),
                                                  );
                                                },
                                                child: Text('Телефон: ${child.parentPhone}',
  ...
  String _formatBirthday(String birthdayString) {
    try {
      ...
      int day = date.day;
      int monthIndex = date.month - 1; // month is 1-indexed, but our list is 0-indexed
      int year = date.year;
